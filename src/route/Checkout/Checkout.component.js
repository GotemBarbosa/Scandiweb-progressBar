import {Checkout as SourceHeader} from 'SourceRoute/Checkout/Checkout.component'
...
import CheckoutProgressiveBar from 'Component/CheckoutProgressiveBar/CheckoutProgressiveBar.component';
    ...
    renderProgressBar(){
        ...
        for(let step in this.stepMap){
            if(step === DETAILS_STEP){
                stepObj['DETAILS_STEP']={
                    id:'DETAILS_STEP',
                    name: 'details'
                }
            }
            if(step === SHIPPING_STEP){
                stepObj['SHIPPING_STEP']={
                    id:'SHIPPING_STEP',
                    name: 'shipping'
                }
            }
            if(step === BILLING_STEP){
                stepObj['BILLING_STEP']={
                    id:'BILLING_STEP',
                    name: 'review & payment'
                }
            }
        ...
        return(
            <CheckoutProgressiveBar steps={stepObj} currentStep={checkoutStep}/>
        )
    }
